...
use Automattic\WooCommerce\Api\Mutations\UpdateCoupon as UpdateCouponCommand;
...
class UpdateCoupon {
	...
	public static function resolve(mixed $root, array $args, mixed $context, ResolveInfo $info): mixed {
		...
		if (array_key_exists('input', $args)) {
			$execute_args['input'] = self::convertUpdateCouponInput($args['input']);
		}
  ...
  0 => 'manage_woocommerce',
	...
	private static function convertUpdateCouponInput(array $data): \Automattic\WooCommerce\Api\InputTypes\UpdateCouponInput {
		$input = new \Automattic\WooCommerce\Api\InputTypes\UpdateCouponInput();
