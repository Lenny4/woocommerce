...
use Automattic\WooCommerce\Api\Enums\DiscountType;
use Automattic\WooCommerce\Api\Types\Coupon;

/**
 * Maps a WC_Coupon to the Coupon DTO.
 *
 * This class is ignored by the GraphQL build script.
 */
#[Ignore]
class CouponMapper {
	public static function fromWcCoupon( \WC_Coupon $wc_coupon ): Coupon {
		$coupon = new Coupon();
		...
		$coupon->status                     = CouponStatus::from( $wc_coupon->get_status() );
